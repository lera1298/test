...
HD_PWD='C:/work/Xilinx_lab/DMA_btn_nex_prj_2/nexys_lin_true_sd19/nexys_lin.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log microblaze_top_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source microblaze_top_wrapper.tcl -notrace
