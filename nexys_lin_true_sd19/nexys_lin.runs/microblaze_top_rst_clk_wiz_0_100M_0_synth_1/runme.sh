...
HD_PWD='D:/fpga_projects/xilinx/nexys_sdcard/nexys_lin_true_sd19/nexys_lin.runs/microblaze_top_rst_clk_wiz_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microblaze_top_rst_clk_wiz_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microblaze_top_rst_clk_wiz_0_100M_0.tcl
