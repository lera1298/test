...
HD_PWD='C:/work/Xilinx_lab/DMA_btn_nex_prj_2/nexys_lin_true_sd19/nexys_lin.runs/microblaze_top_vio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microblaze_top_vio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microblaze_top_vio_0_0.tcl
